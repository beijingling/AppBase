...
public class SystemUtil
{
    ...
    {
        ConnectivityManager connectivityManager = (ConnectivityManager) BaseApplication.Companion.getAppContext().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static boolean isConnected()
    {
        ...
        try
        {
            ConnectivityManager mConnectivityManager = (ConnectivityManager) BaseApplication.Companion.getAppContext().getSystemService(Context.CONNECTIVITY_SERVICE);
